...
- フィルタリング・検索
  - 将来的な拡張要件。初期リリースでは全件表示とし、必要に応じて UI にプレースホルダーを残す。
- 施設登録
...
## 4. 画面構成（機能レベル）
- **ページヘッダー**
  - タイトル（例: 「施設マスタ管理」）とサブ説明を表示し、利用者に画面の目的を伝える。
- **操作バー**
  - 「施設追加」「一覧更新」など頻度の高い操作を集約する。
  - 将来的なフィルタ／CSV 出力などの操作スペースを確保。
- **一覧テーブル**
